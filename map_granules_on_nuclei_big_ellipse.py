# -*- coding: utf-8 -*-
"""
Created on Mon Mar  3 22:16:17 2025
...
out_folder = "D:/Downloads/salu_filtered_координаты_big_ellipse"
...
for i in range(1,6):
    for j in range(1,3):
        nuclei_folder = os.listdir("D:/Downloads/all_archive/salu/salu_nuclei")# Папки с "tables"
        image_folder = os.listdir(f"D:/Games/Icy_2.5.2/Icy/salu/salu_{i}_{j}_filtered") # Папки без "tables"
        ...
        for image_file_pattern in image_file_patterns:
            ...
            data1 = pd.read_csv(os.path.join(f"D:/Games/Icy_2.5.2/Icy/salu/salu_{i}_{j}_filtered", image_file_pattern + "_1.tif_DetectionResults.xlsx"))  # Первый файл
            data2 = pd.read_csv(os.path.join(f"D:/Games/Icy_2.5.2/Icy/salu/salu_{i}_{j}_filtered", image_file_pattern + "_2.tif_DetectionResults.xlsx"))  # Второй файл
            ...
            def count_points_per_nucleus(data_x, data_y, centers_x, centers_y, radius):
                ...
                for cx, cy in zip(centers_x, centers_y):
                    ...
                    for x, y in zip(data_x, data_y):
                        if is_within_circle(x, y, cx, cy, radius):
                            count += 1
                            dots.append([x,y])
